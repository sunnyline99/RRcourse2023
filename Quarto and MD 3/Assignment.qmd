...
load(paste0("C:\\Users\\ds443709\\Desktop\\ReproducibleResearch\\repositories\\RRcourse2023\\Data\\season_",params$season, ".RData"))
```

# Game of Thrones - Season `r p` summary in numbers
...
Season `r p` of Game of Thrones consisted of `r episodes_no` episodes that aired between April 17 and June 19, 2011 on HBO. The show gathered an average of `r avg_viewers` first-day TV viewers in the US, with the number growing from 2.22 to 3.04 million by the end of the season.
